...
## Achado 2 - Barra administrativa do WordPress visivel
...
O seletor `#wpadminbar` foi encontrado em `/contato/` para uma execucao de visitante automatizado.

**Impacto:**

A barra administrativa do WordPress nao deve aparecer para visitantes publicos. Esse comportamento pode indicar cache de pagina autenticada, configuracao incorreta de cache/CDN, sessao indevida ou exposicao de elementos administrativos.

**Recomendacao:**

Revisar cache de pagina, CDN, plugins de otimizacao, regras de variacao por cookie e qualquer mecanismo que possa servir HTML de usuario autenticado para visitantes anonimos.

## Achado 3 - Rate limit HTTP 429 em paginas internas
